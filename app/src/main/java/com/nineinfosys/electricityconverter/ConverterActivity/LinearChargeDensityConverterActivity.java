...
import com.nineinfosys.electricityconverter.ConverterActivityList.ConversionLinearChargeListActivity;
...
public class LinearChargeDensityConverterActivity extends AppCompatActivity implements View.OnClickListener,TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(LinearChargeDensityConverterActivity.this, getString(R.string.ads_app_id));
