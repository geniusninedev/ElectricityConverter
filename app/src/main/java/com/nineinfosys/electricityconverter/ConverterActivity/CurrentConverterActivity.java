...
import com.nineinfosys.electricityconverter.ConverterActivityList.CurrentConverterListActivity;
...
public class CurrentConverterActivity extends AppCompatActivity implements View.OnClickListener,TextWatcher {
    ...
    CurrentConverter.ConversionResults item;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(CurrentConverterActivity.this, getString(R.string.ads_app_id));
        ...
        listLinearChargeFirstfrom.add("Ampere - A");
        listLinearChargeFirstfrom.add("Kiloampere - kA");
        listLinearChargeFirstfrom.add("Milliampere - mA");
        //for first time running spinner
        listLinearChargeFirsttempTo.add("Ampere - A");
        listLinearChargeFirsttempTo.add("Kiloampere - kA");
        listLinearChargeFirsttempTo.add("Milliampere - mA");
        // Creating adapter for spinner
        ArrayAdapter<String> Adapter = new ArrayAdapter<String>(CurrentConverterActivity.this, android.R.layout.simple_spinner_item, listLinearChargeFirstfrom);
        ArrayAdapter<String> AdapterTempTo = new ArrayAdapter<String>(CurrentConverterActivity.this, android.R.layout.simple_spinner_item, listLinearChargeFirsttempTo);
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                switch (stringSwitchSate) {
                    ...
                    case "false":
                        ...
                        //for first time running spinner
                        listLinearChargefrom.add("Ampere - A");
                        listLinearChargefrom.add("Kiloampere - kA");
                        listLinearChargefrom.add("Milliampere - mA");

                        //for first time running spinner
                        listLinearChargeTo.add("Ampere - A");
                        listLinearChargeTo.add("Kiloampere - kA");
                        listLinearChargeTo.add("Milliampere - mA");
                        break;
                    ...
                    case "true":
                        ...
                        listLinearChargefrom.add("Kiloampere - kA");
                        listLinearChargefrom.add("Milliampere - mA");
                        listLinearChargefrom.add("Biot - Bi");
                        listLinearChargefrom.add("Abampere - abA");
                        listLinearChargefrom.add("EMU of current - emuA");
                        listLinearChargefrom.add("Statampere - stA");
                        listLinearChargefrom.add("ESU of current - esuA");
                        listLinearChargefrom.add("CGS e.m.unit - e.m.unit");
                        listLinearChargefrom.add("CGS e.s.unit - e.s.unit");
                        ...
                        listLinearChargeTo.add("Kiloampere - kA");
                        listLinearChargeTo.add("Milliampere - mA");
                        listLinearChargeTo.add("Biot - Bi");
                        listLinearChargeTo.add("Abampere - abA");
                        listLinearChargeTo.add("EMU of current - emuA");
                        listLinearChargeTo.add("Statampere - stA");
                        listLinearChargeTo.add("ESU of current - esuA");
                        listLinearChargeTo.add("CGS e.m.unit - e.m.unit");
                        listLinearChargeTo.add("CGS e.s.unit - e.s.unit");
                ...
                // Creating adapter for spinner
                ArrayAdapter<String> Adapter2 = new ArrayAdapter<String>(CurrentConverterActivity.this, android.R.layout.simple_spinner_item, listLinearChargefrom);
                ArrayAdapter<String> AdapterTempTo2 = new ArrayAdapter<String>(CurrentConverterActivity.this, android.R.layout.simple_spinner_item, listLinearChargeTo);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button_list_fullreport:
                doubleEdittextvalue = Double.parseDouble(editTextValue.getText().toString().trim());
                Intent i = new Intent(this,CurrentConverterListActivity.class);
    ...
    public void calcualteValue(String strSpinnerFromvalue1, String strSpinnerTovalue2, double doubleEdittextvalue1) {
        ...
        try {
            ...
            CurrentConverter c = new CurrentConverter(strSpinnerFromvalue1, (int) doubleEdittextvalue1);
    ...
    private void conversion(String strSpinnerTovalue2) {
        ...
        switch (strSpinnerTovalue2) {
            ...
            case "Ampere - A":
                editTextValueTo.setText(strAmpere);
                break;
            case "Kiloampere - kA":
                editTextValueTo.setText(strKiloampere);
                break;

            case "Milliampere - mA":
                editTextValueTo.setText(strMilliampere);
                break;
            case"Biot - Bi" :
                editTextValueTo.setText(strBiot);
                break;
            case "Abampere - abA":
                editTextValueTo.setText(strAbampere);
                break;
            case "EMU of current - emuA":
                editTextValueTo.setText(strEMUofcurrent);
                break;
            case "Statampere - stA":
                editTextValueTo.setText(strStatampere);
                break;
            case "ESU of current - esuA" :
                editTextValueTo.setText(strESUofcurrent);
                break;
            case "CGS e.m.unit - e.m.unit":
                editTextValueTo.setText(strCGSemunit);
                break;

            case "CGS e.s.unit - e.s.unit":
                editTextValueTo.setText(strCGSesunit);
                break;
